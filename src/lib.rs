...
//! wire protocol that library writes, and the three constants below that pin
//! this crate to one version of that header.
//!
...
//! header that moved. [`batch::WIRE_VERSION`] is the same number narrowed once
//! to the `u16` the batch header actually carries.
//!
...
//! is simply compiled out. [`batch`] never links: it reads bytes.
//!
